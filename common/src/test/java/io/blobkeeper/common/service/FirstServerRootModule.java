...
public class FirstServerRootModule extends AbstractModule {
    private static final Logger log = LoggerFactory.getLogger(FirstServerRootModule.class);
    ...
    protected Properties loadProperties() throws Exception {
        return PropertiesLoader.loadProperties(propertyFileName, FirstServerRootModule.class);
    }
